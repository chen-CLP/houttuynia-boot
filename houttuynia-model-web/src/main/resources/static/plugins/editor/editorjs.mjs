...
let Rt = (r = 21) => crypto.getRandomValues(new Uint8Array(r)).reduce((e, t) => (t &= 63, t < 36 ? e += t.toString(36) : t < 62 ? e += (t - 26).toString(36).toUpperCase() : t > 62 ? e += "-" : e += "_", e), "");
var Ge = /* @__PURE__ */ ((r) => (r.VERBOSE = "VERBOSE", r.INFO = "INFO", r.WARN = "WARN", r.ERROR = "ERROR", r))(Ge || {});
const B = {
  BACKSPACE: 8,
  TAB: 9,
  ENTER: 13,
...
const L = me.bind(window, !1), K = me.bind(window, !0);
function oe(r) {
...
async function Ht(r, e = () => {
  ...
  async function o(i, n, s) {
    try {
      await i.function(i.data), await n(We(i.data) ? {} : i.data);
    } catch {
      s(We(i.data) ? {} : i.data);
    }
  }
...
function Se(r, ...e) {
  ...
  if (z(r) && z(t))
    for (const o in t)
      z(t[o]) ? (r[o] || Object.assign(r, { [o]: {} }), Se(r[o], t[o])) : Object.assign(r, { [o]: t[o] });
  return Se(r, ...e);
}
function Le(r) {
  const e = $t();
...
class d {
  ...
  static findAllInputs(e) {
    return Qe(e.querySelectorAll(d.allInputsSelector)).reduce((t, o) => d.isNativeInput(o) || d.containsOnlyInlineElements(o) ? [...t, o] : [...t, ...d.getDeepestBlockElements(o)], []);
  }
  /**
...
class C {
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    if (this.nodes = {}, this.listeners = new Oe(), this.readOnlyMutableListeners = {
      /**
...
const Me = "redactor dom changed", nt = "block changed", st = "fake cursor is about to be toggled", rt = "fake cursor have been set";
function Ke(r, e) {
  return r.mergeable && r.name === e.name;
}
function eo(r, e) {
  const t = e == null ? void 0 : e.export;
  return D(t) ? t(r) : J(t) ? r[t] : (t !== void 0 && L("Conversion «export» property must be a string or function. String means key of saved data object to export. Function should export processed string to export."), "");
}
function to(r, e) {
...
var q = /* @__PURE__ */ ((r) => (r.APPEND_CALLBACK = "appendCallback", r.RENDERED = "rendered", r.MOVED = "moved", r.UPDATED = "updated", r.REMOVED = "removed", r.ON_PASTE = "onPaste", r))(q || {});
class F extends we {
  /**
    ...
    super(), this.cachedInputs = [], this.toolRenderedElement = null, this.tunesInstances = /* @__PURE__ */ new Map(), this.defaultTunesInstances = /* @__PURE__ */ new Map(), this.unavailableTunesData = {}, this.inputIndex = 0, this.editorEventBus = null, this.handleFocus = () => {
      ...
      c || u ? h = !0 : h = !(l.length > 0 && l.every((m) => {
        ...
        return [
          ...
          ...Array.from(v),
          O
        ].some((N) => d.isElement(N) ? N.dataset.mutationFree === "true" : !1);
  ...
  set selected(e) {
    ...
    (t || o) && ((i = this.editorEventBus) == null || i.emit(st, { state: e }), t ? k.addFakeCursor() : k.removeFakeCursor(this.holder), (n = this.editorEventBus) == null || n.emit(rt, { state: e }));
  }
  /**
  ...
  async getActiveToolboxEntry() {
    ...
    return e.find((i) => Object.entries(i.data).some(([n, s]) => t[n] && Vt(t[n], s)));
  }
  /**
    ...
    return [...this.tunesInstances.values(), ...this.defaultTunesInstances.values()].forEach((n) => {
      if (D(n.wrap))
        try {
          ...
          L(`Tune ${n.constructor.name} wrap method throws an Error %o`, "warn", s);
        }
    }), e.appendChild(i), e;
  }
  /**
...
`);
      ...
      function v(b, g) {
        for (var E = [], T = {}, A = 0; A < b.length; A++) {
          var S = b[A], H = g.base ? S[0] + g.base : S[0], M = { css: S[1], media: S[2], sourceMap: S[3] };
...
`);
      ...
      function x(b, g) {
        ...
        if (g.singleton) {
          var H = h++;
          E = u || (u = N(g)), T = R.bind(null, E, H, !1), A = R.bind(null, E, H, !0);
        } else
          b.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (E = function(M) {
            ...
            return M.attrs.type === void 0 && (M.attrs.type = "text/css"), M.attrs.rel = "stylesheet", y($, M.attrs), O(M, $), $;
          }(g), T = (function(M, $, ce) {
            var Q = ce.css, Ee = ce.sourceMap, At = $.convertToAbsoluteUrls === void 0 && Ee;
            ($.convertToAbsoluteUrls || At) && (Q = m(Q)), Ee && (Q += `
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(Ee)))) + " */");
            var _t = new Blob([Q], { type: "text/css" }), Ue = M.href;
            M.href = URL.createObjectURL(_t), Ue && URL.revokeObjectURL(Ue);
          }).bind(null, E, g), A = function() {
            _(E), E.href && URL.revokeObjectURL(E.href);
          }) : (E = N(g), T = (function(M, $) {
            var ce = $.css, Q = $.media;
            if (Q && M.setAttribute("media", Q), M.styleSheet)
              M.styleSheet.cssText = ce;
            else {
              for (; M.firstChild; )
                M.removeChild(M.firstChild);
              M.appendChild(document.createTextNode(ce));
            }
      ...
      t.exports = function(b, g) {
        ...
        return p(E, g), function(T) {
          ...
          for (T && p(v(T, g), g), S = 0; S < A.length; S++) {
            var M;
            if ((M = A[S]).refs === 0) {
              for (var $ = 0; $ < M.parts.length; $++)
                M.parts[$]();
              delete a[M.id];
            }
          }
...
`);
      ...
      function R(b, g, E, T) {
        var A = E ? "" : T.css;
        if (b.styleSheet)
          b.styleSheet.cssText = I(g, A);
        else {
          var S = document.createTextNode(A), H = b.childNodes;
      ...
      t.exports = (n = "cdx-notifies", s = "cdx-notify", a = "cdx-notify__cross", l = "cdx-notify__button--confirm", c = "cdx-notify__button--cancel", u = "cdx-notify__input", h = "cdx-notify__button", f = "cdx-notify__btns-wrapper", { alert: m = function(p) {
        var v = document.createElement("DIV"), O = document.createElement("DIV"), _ = p.message, N = p.style;
        return v.classList.add(s), N && v.classList.add(s + "--" + N), v.innerHTML = _, O.classList.add(a), O.addEventListener("click", v.remove.bind(v)), v.appendChild(O), v;
      }, confirm: function(p) {
        var v = m(p), O = document.createElement("div"), _ = document.createElement("button"), N = document.createElement("button"), y = v.querySelector("." + a), x = p.cancelHandler, w = p.okHandler;
        return O.classList.add(f), _.innerHTML = p.okText || "Confirm", N.innerHTML = p.cancelText || "Cancel", _.classList.add(h), N.classList.add(h), _.classList.add(l), N.classList.add(c), x && typeof x == "function" && (N.addEventListener("click", x), y.addEventListener("click", x)), w && typeof w == "function" && _.addEventListener("click", w), _.addEventListener("click", v.remove.bind(v)), N.addEventListener("click", v.remove.bind(v)), O.appendChild(_), O.appendChild(N), v.appendChild(O), v;
      }, prompt: function(p) {
        var v = m(p), O = document.createElement("div"), _ = document.createElement("button"), N = document.createElement("input"), y = v.querySelector("." + a), x = p.cancelHandler, w = p.okHandler;
        return O.classList.add(f), _.innerHTML = p.okText || "Ok", _.classList.add(h), _.classList.add(l), N.classList.add(u), p.placeholder && N.setAttribute("placeholder", p.placeholder), p.default && (N.value = p.default), p.inputType && (N.type = p.inputType), x && typeof x == "function" && y.addEventListener("click", x), w && typeof w == "function" && _.addEventListener("click", function() {
          w(N.value);
        }), _.addEventListener("click", v.remove.bind(v)), O.appendChild(N), O.appendChild(_), v.appendChild(O), v;
      }, getWrapper: function() {
    ...
    t.prototype.clean = function(h) {
      ...
      if (p)
        do {
          ...
          var _ = !!f.parentNode, N = i(f) && i(p) && _, y = p.nodeName.toLowerCase(), x = l(this.config, y, p), w = v && O;
          if (w || c(p, x) || !this.config.keepNestedBlockElements && N) {
...
var fo = lt.exports;
const go = /* @__PURE__ */ be(fo);
function ct(r, e) {
  return r.map((t) => {
    const o = D(e) ? e(t.tool) : e;
    return V(o) || (t.data = _e(t.data, o)), t;
  });
}
function Z(r, e = {}) {
  const t = {
  ...
  return new go(t).clean(r);
}
function _e(r, e) {
  return Array.isArray(r) ? bo(r, e) : z(r) ? mo(r, e) : J(r) ? ko(r, e) : r;
}
function bo(r, e) {
  return r.map((t) => _e(t, e));
}
function mo(r, e) {
  const t = {};
  for (const o in r) {
    if (!Object.prototype.hasOwnProperty.call(r, o))
      continue;
    const i = r[o], n = vo(e[o]) ? e[o] : e;
    t[o] = _e(i, n);
  }
  return t;
}
function ko(r, e) {
  return z(e) ? Z(r, e) : e === !1 ? Z(r, {}) : r;
}
function vo(r) {
  return z(r) || Ft(r) || D(r);
}
...
const Lo = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M9 12L9 7.1C9 7.04477 9.04477 7 9.1 7H10.4C11.5 7 14 7.1 14 9.5C14 9.5 14 12 11 12M9 12V16.8C9 16.9105 9.08954 17 9.2 17H12.5C14 17 15 16 15 14.5C15 11.7046 11 12 11 12M9 12H11"/></svg>', ut = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 10L11.8586 14.8586C11.9367 14.9367 12.0633 14.9367 12.1414 14.8586L17 10"/></svg>', Oo = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 15L11.8586 10.1414C11.9367 10.0633 12.0633 10.0633 12.1414 10.1414L17 15"/></svg>', Ao = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 8L12 12M12 12L16 16M12 12L16 8M12 12L8 16"/></svg>', _o = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="4" stroke="currentColor" stroke-width="2"/></svg>', No = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M13.34 10C12.4223 12.7337 11 17 11 17"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M14.21 7H14.2"/></svg>', Xe = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7.69998 12.6L7.67896 12.62C6.53993 13.7048 6.52012 15.5155 7.63516 16.625V16.625C8.72293 17.7073 10.4799 17.7102 11.5712 16.6314L13.0263 15.193C14.0703 14.1609 14.2141 12.525 13.3662 11.3266L13.22 11.12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16.22 11.12L16.3564 10.9805C17.2895 10.0265 17.3478 8.5207 16.4914 7.49733V7.49733C15.5691 6.39509 13.9269 6.25143 12.8271 7.17675L11.3901 8.38588C10.0935 9.47674 9.95706 11.4241 11.0888 12.6852L11.12 12.72"/></svg>', Ro = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.40999 7.29999H9.4"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 7.29999H14.59"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.30999 12H9.3"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 12H14.59"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.40999 16.7H9.4"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 16.7H14.59"/></svg>', Do = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 7V12M12 17V12M17 12H12M12 12H7"/></svg>', Po = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><circle cx="10.5" cy="10.5" r="5.5" stroke="currentColor" stroke-width="2"/><line x1="15.4142" x2="19" y1="15" y2="18.5858" stroke="currentColor" stroke-linecap="round" stroke-width="2"/></svg>', Fo = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M15.7795 11.5C15.7795 11.5 16.053 11.1962 16.5497 10.6722C17.4442 9.72856 17.4701 8.2475 16.5781 7.30145V7.30145C15.6482 6.31522 14.0873 6.29227 13.1288 7.25073L11.8796 8.49999"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8.24517 12.3883C8.24517 12.3883 7.97171 12.6922 7.47504 13.2161C6.58051 14.1598 6.55467 15.6408 7.44666 16.5869V16.5869C8.37653 17.5731 9.93744 17.5961 10.8959 16.6376L12.1452 15.3883"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M17.7802 15.1032L16.597 14.9422C16.0109 14.8624 15.4841 15.3059 15.4627 15.8969L15.4199 17.0818"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6.39064 9.03238L7.58432 9.06668C8.17551 9.08366 8.6522 8.58665 8.61056 7.99669L8.5271 6.81397"/><line x1="12.1142" x2="11.7" y1="12.2" y2="11.7858" stroke="currentColor" stroke-linecap="round" stroke-width="2"/></svg>', Ho = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><rect width="14" height="14" x="5" y="5" stroke="currentColor" stroke-width="2" rx="4"/><line x1="12" x2="12" y1="9" y2="12" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 15.02V15.01"/></svg>';
class P {
  /**
...
const pt = class he {
  ...
  leafNodesAndReturnIndex(e) {
    if (this.items.length === 0)
      return this.cursor;
    let t = this.cursor;
    return t === -1 ? t = e === he.directions.RIGHT ? -1 : 0 : this.items[t].classList.remove(this.focusedCssClass), e === he.directions.RIGHT ? t = (t + 1) % this.items.length : t = (this.items.length + t - 1) % this.items.length, d.canSetCaret(this.items[t]) && se(() => k.setCursor(this.items[t]), 50)(), this.items[t].classList.add(this.focusedCssClass), t;
  }
};
pt.directions = {
  RIGHT: "right",
...
class G {
  ...
  constructor(e) {
    ...
    }, this.iterator = new de(e.items, e.focusedItemClass), this.activateCallback = e.activateCallback, this.allowedKeys = e.allowedKeys || G.usedKeys;
  }
  /**
...
class pe {
  ...
  constructor({ items: e, onSearch: t, placeholder: o }) {
    this.listeners = new Oe(), this.items = e, this.onSearch = t, this.render(o);
  }
  /**
...
const ft = class ue {
   ...
   */
  lock() {
    Ye ? this.lockHard() : document.body.classList.add(ue.CSS.scrollLocked);
  }
  /**
   * Unlocks body element scroll
   */
  unlock() {
    Ye ? this.unlockHard() : document.body.classList.remove(ue.CSS.scrollLocked);
  }
  /**
...
let jo = ft;
var zo = Object.defineProperty, Uo = Object.getOwnPropertyDescriptor, $o = (r, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? Uo(e, t) : e, n = r.length - 1, s; n >= 0; n--)
    (s = r[n]) && (i = (o ? s(e, t, i) : s(i)) || i);
  return o && i && zo(e, t, i), i;
}, ge = /* @__PURE__ */ ((r) => (r.Close = "close", r))(ge || {});
const gt = class j extends we {
  /**
   ...
   */
  constructor(e) {
    super(), this.scopeElement = document.body, this.listeners = new Oe(), this.scrollLocker = new jo(), this.nodes = {
      wrapper: null,
      popover: null,
    ...
    }, this.items = e.items.map((t) => new P(t)), e.scopeElement !== void 0 && (this.scopeElement = e.scopeElement), e.messages && (this.messages = {
      ...this.messages,
      ...e.messages
   ...
   */
  hide() {
    this.nodes.popover.classList.remove(j.CSS.popoverOpened), this.nodes.popover.classList.remove(j.CSS.popoverOpenTop), this.nodes.overlay.classList.add(j.CSS.overlayHidden), this.flipper.deactivate(), this.items.forEach((e) => e.reset()), this.search !== void 0 && this.search.clear(), te() && this.scrollLocker.unlock(), this.emit(
      "close"
      /* Close */
    );
  }
  ...
  make() {
    ...
    }), this.nodes.popover.appendChild(this.nodes.nothingFoundMessage), this.nodes.items = d.make("div", [j.CSS.items]), this.items.forEach((e) => {
  ...
  addSearch() {
    ...
    e.classList.add(j.CSS.search), this.nodes.popover.insertBefore(e, this.nodes.popover.firstChild);
  }
  /**
   ...
   */
  addCustomContent(e) {
    this.nodes.customContent = e, this.nodes.customContent.classList.add(j.CSS.customContent), this.nodes.popover.insertBefore(e, this.nodes.popover.firstChild);
  }
  /**
  ...
  get height() {
    ...
    return t.style.visibility = "hidden", t.style.position = "absolute", t.style.top = "-1000px", t.classList.add(j.CSS.popoverOpened), document.body.appendChild(t), e = t.offsetHeight, t.remove(), e;
  }
  /**
  ...
  toggleNothingFoundMessage(e) {
    this.nodes.nothingFoundMessage.classList.toggle(j.CSS.nothingFoundMessageDisplayed, e);
  }
  /**
  ...
  toggleCustomContent(e) {
    var t;
    (t = this.nodes.customContent) == null || t.classList.toggle(j.CSS.customContentHidden, e);
  }
  /**
...
class Wo extends C {
  ...
  open(e = this.Editor.BlockManager.currentBlock) {
    ...
    this.eventsDispatcher.emit(this.events.opened), this.popover = new bt({
      ...
      messages: {
        nothingFound: Y.ui(X.ui.popover, "Nothing found"),
        search: Y.ui(X.ui.popover, "Filter")
      }
...
class W extends C {
  ...
  make() {
    ...
    const e = d.make("div", W.CSS.conversionToolbarLabel, {
      textContent: Y.ui(X.ui.inlineToolbar.converter, "Convert to")
    });
  ...
  open() {
    this.filterTools(), this.opened = !0, this.nodes.wrapper.classList.add(W.CSS.conversionToolbarShowed), window.requestAnimationFrame(() => {
      this.flipper.activate(this.tools.map((e) => e.button).filter((e) => !e.classList.contains(W.CSS.conversionToolHidden))), this.flipper.focusFirst(), D(this.togglingCallback) && this.togglingCallback(!0);
    });
  }
  /**
   ...
   */
  close() {
    this.opened = !1, this.flipper.deactivate(), this.nodes.wrapper.classList.remove(W.CSS.conversionToolbarShowed), D(this.togglingCallback) && this.togglingCallback(!1);
  }
  /**
  ...
  addTool(e, t) {
    ...
    o.dataset.tool = e, i.innerHTML = t.icon, d.append(o, i), d.append(o, d.text(Y.t(X.toolNames, t.title || re(e))));
...
const ae = new Xo();
var Vo = Object.defineProperty, qo = Object.getOwnPropertyDescriptor, kt = (r, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? qo(e, t) : e, n = r.length - 1, s; n >= 0; n--)
    (s = r[n]) && (i = (o ? s(e, t, i) : s(i)) || i);
  return o && i && Vo(e, t, i), i;
}, ke = /* @__PURE__ */ ((r) => (r.Opened = "toolbox-opened", r.Closed = "toolbox-closed", r.BlockAdded = "toolbox-block-added", r))(ke || {});
const Re = class vt extends we {
  /**
   * Toolbox constructor
   *
  ...
  make() {
    ...
    }), this.popover.on(ge.Close, this.onPopoverClose), this.enableShortcuts(), this.nodes.toolbox = this.popover.getElement(), this.nodes.toolbox.classList.add(vt.CSS.toolbox), this.nodes.toolbox;
  }
  /**
  ...
  destroy() {
    var e;
    super.destroy(), this.nodes && this.nodes.toolbox && (this.nodes.toolbox.remove(), this.nodes.toolbox = null), this.removeAllShortcuts(), (e = this.popover) == null || e.off(ge.Close, this.onPopoverClose);
  }
  /**
  ...
  get toolboxItemsToBeDisplayed() {
    const e = (t, o) => ({
      icon: t.icon,
      title: Y.t(X.toolNames, t.title || re(o.name)),
      name: o.name,
      onActivate: () => {
  ...
  removeAllShortcuts() {
    this.toolsToBeDisplayed.forEach((e) => {
      const t = e.shortcut;
      t && ae.remove(this.api.ui.nodes.redactor, t);
    });
  }
  /**
   * Inserts new block
  ...
  async insertNewBlock(e, t) {
    ...
    a.call(q.APPEND_CALLBACK), this.api.caret.setToBlock(n), this.emit("toolbox-block-added", {
      block: a
...
kt([
  le
], Re.prototype, "toolsToBeDisplayed", 1);
kt([
  le
], Re.prototype, "toolboxItemsToBeDisplayed", 1);
let Zo = Re;
const xt = "block hovered";
class Go extends C {
  /**
   * @class
   * @param moduleConfiguration - Module Configuration
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    super({
      config: e,
      eventsDispatcher: t
    }), this.toolboxInstance = null, this.tooltip = new Ne();
  }
  /**
   * CSS styles
   *
  ...
  make() {
    ...
    const e = d.make("div");
    e.appendChild(document.createTextNode(Y.ui(X.ui.toolbar.toolbox, "Add"))), e.appendChild(d.make("div", this.CSS.plusButtonShortcut, {
      textContent: "⇥ Tab"
      ...
      Y.ui(X.ui.blockTunes.toggler, "Click to tune"),
      {
        hidingDelay: 400
      }
   ...
   */
  makeToolbox() {
    return this.toolboxInstance = new Zo({
      api: this.Editor.API.methods,
      tools: this.Editor.Tools.blockTools,
      i18nLabels: {
        filter: Y.ui(X.ui.popover, "Filter"),
        nothingFound: Y.ui(X.ui.popover, "Nothing found")
      }
  ...
  enableModuleBindings() {
    ...
    }, !0), te() || this.eventsDispatcher.on(xt, (e) => {
      var t;
...
var ye = /* @__PURE__ */ ((r) => (r[r.Block = 0] = "Block", r[r.Inline = 1] = "Inline", r[r.Tune = 2] = "Tune", r))(ye || {}), ve = /* @__PURE__ */ ((r) => (r.Shortcut = "shortcut", r.Toolbox = "toolbox", r.EnabledInlineTools = "inlineToolbar", r.EnabledBlockTunes = "tunes", r.Config = "config", r))(ve || {}), wt = /* @__PURE__ */ ((r) => (r.Shortcut = "shortcut", r.SanitizeConfig = "sanitize", r))(wt || {}), ne = /* @__PURE__ */ ((r) => (r.IsEnabledLineBreaks = "enableLineBreaks", r.Toolbox = "toolbox", r.ConversionConfig = "conversionConfig", r.IsReadOnlySupported = "isReadOnlySupported", r.PasteConfig = "pasteConfig", r))(ne || {}), De = /* @__PURE__ */ ((r) => (r.IsInline = "isInline", r.Title = "title", r))(De || {}), yt = /* @__PURE__ */ ((r) => (r.IsTune = "isTune", r))(yt || {});
class Pe {
  /**
   * @class
...
class Jo extends C {
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    ...
    }, this.opened = !1, this.toolbarVerticalMargin = te() ? 20 : 6, this.buttonsList = null, this.width = 0, this.flipper = null, this.tooltip = new Ne();
  }
  /**
   * Toggles read-only mode
   *
  ...
  addConversionToggler() {
    ...
    }), te() === !1 && this.tooltip.onHover(this.nodes.conversionToggler, Y.ui(X.ui.inlineToolbar.converter, "Convert to"), {
      placement: "top",
      hidingDelay: 100
    });
  }
  ...
  async setConversionTogglerContent() {
    ...
    this.nodes.conversionTogglerContent.innerHTML = s.icon || s.title || re(o);
  }
  /**
   ...
   */
  addToolsFiltered() {
    const e = k.get(), t = this.Editor.BlockManager.getBlock(e.anchorNode);
...
class Qo extends C {
  ...
  beforeKeydownProcessing(e) {
    this.needToolbarClosing(e) && Je(e.keyCode) && (this.Editor.Toolbar.close(), this.Editor.ConversionToolbar.close(), e.ctrlKey || e.metaKey || e.altKey || e.shiftKey || (this.Editor.BlockManager.clearFocused(), this.Editor.BlockSelection.clearSelection(e)));
  }
  /**
   * Key up on Block:
  ...
  tabPressed(e) {
    ...
    if (!n)
      return;
    const s = n.isEmpty, a = n.tool.isDefault && s, l = !s && i.opened, c = !s && !k.isCollapsed && o.opened;
  ...
  backspace(e) {
    ...
    Ke(i, n) ? this.mergeBlocks(n, i) : o.setToBlock(n, o.positions.END);
  }
  /**
  ...
  delete(e) {
    ...
    Ke(i, n) ? this.mergeBlocks(i, n) : o.setToBlock(n, o.positions.START);
  }
  /**
   * Merge passed Blocks
   *
  ...
  needToolbarClosing(e) {
    const t = e.keyCode === B.ENTER && this.Editor.Toolbar.toolbox.opened, o = e.keyCode === B.ENTER && this.Editor.BlockSettings.opened, i = e.keyCode === B.ENTER && this.Editor.InlineToolbar.opened, n = e.keyCode === B.ENTER && this.Editor.ConversionToolbar.opened, s = e.keyCode === B.TAB;
...
class Te {
   ...
   */
  get nodes() {
    return Qe(this.workingArea.children);
  }
  /**
...
const Ve = "block-removed", qe = "block-added", ei = "block-moved", Ze = "block-changed";
class ti {
  constructor() {
...
class oi extends C {
  ...
  composeBlock({
    ...
    const n = this.Editor.ReadOnly.isEnabled, s = this.Editor.Tools.blockTools.get(e), a = new F({
      id: o,
      data: t,
      tool: s,
      api: this.Editor.API,
  ...
  insert({
    ...
    return s && this.blockDidMutated(Ve, this.getBlockByIndex(l), {
      index: l
    }), this._blocks.insert(l, c, s), this.blockDidMutated(qe, c, {
      index: l
  ...
  async update(e, t) {
    ...
    return this._blocks.replace(n, i), this.blockDidMutated(Ze, i, {
      index: n
    }), i;
  }
  /**
  ...
  removeBlock(e, t = !0) {
    return new Promise((o) => {
      ...
      e.destroy(), this._blocks.remove(i), this.blockDidMutated(Ve, e, {
        index: i
  ...
  bindBlockEvents(e) {
    ...
    this.readOnlyMutableListeners.on(e.holder, "keydown", (o) => {
      ...
      t.dragLeave(o);
    }), e.on("didMutated", (o) => this.blockDidMutated(Ze, o, {
  ...
  blockDidMutated(e, t, o) {
    ...
    return this.eventsDispatcher.emit(nt, {
      event: i
    }), t;
  }
}
class ii extends C {
  ...
  clearSelection(e, t = !1) {
    ...
    const s = e && e instanceof KeyboardEvent, a = s && Je(e.keyCode);
    if (this.anyBlockSelected && s && a && !k.isSelectionExists) {
  ...
  copySelectedBlocks(e) {
    ...
    this.selectedBlocks.forEach((n) => {
      const s = Z(n.holder.innerHTML, this.sanitizerConfig), a = d.make("p");
...
class xe extends C {
  ...
  get isAtEnd() {
    ...
    if (t.nodeType !== Node.TEXT_NODE && t.childNodes.length && (t.childNodes[i - 1] ? (t = t.childNodes[i - 1], i = t.textContent.length) : (t = t.childNodes[0], i = 0)), d.isLineBreakTag(o) || d.isEmpty(o)) {
      ...
      if (s.every((l, c) => c === s.length - 1 && d.isLineBreakTag(l) || d.isEmpty(l) && !d.isLineBreakTag(l)) && i === t.textContent.length)
        return !0;
    }
  ...
  setToBlock(e, t = this.positions.DEFAULT, o = 0) {
    ...
    if (!n)
      return;
    const s = d.getDeepestNode(n, t === this.positions.END), a = d.getContentLength(s);
    switch (!0) {
  ...
  navigateNext() {
    ...
    return n ? (i ? this.setToInput(i, this.positions.START) : this.setToBlock(s, this.positions.START), !0) : !1;
  }
  /**
...
const Et = class Bt extends C {
  constructor() {
    super(...arguments), this.MIME_TYPE = "application/x-editor-js", this.toolsTags = {}, this.tagsByTool = {}, this.toolsPatterns = [], this.toolsFiles = {}, this.exceptionList = [], this.processTool = (e) => {
      ...
      !i || this.isNativeBehaviour(e.target) && !e.clipboardData.types.includes("Files") || i && this.exceptionList.includes(i.name) || (e.preventDefault(), this.processDataTransfer(e.clipboardData), t.clearFocused(), o.close());
    };
  }
  /**
  ...
  async processDataTransfer(e, t = !1) {
    ...
    const c = Object.keys(this.toolsTags).reduce((f, m) => (f[m.toLowerCase()] = this.toolsTags[m].sanitizationConfig ?? {}, f), {}), u = Object.assign({}, c, o.getAllInlineToolsSanitizeConfig(), { br: {} }), h = Z(l, u);
   ...
   */
  collectTagNames(e) {
    return J(e) ? [e] : z(e) ? Object.keys(e) : [];
  }
  /**
  ...
  getFilesConfig(e) {
    ...
    !o && !i || (o && !Array.isArray(o) && (L(`«extensions» property of the onDrop config for «${e.name}» Tool should be an array`), o = []), i && !Array.isArray(i) && (L(`«mimeTypes» property of the onDrop config for «${e.name}» Tool should be an array`), i = []), i && (i = i.filter((n) => zt(n) ? !0 : (L(`MIME type value «${n}» for the «${e.name}» Tool is not a valid MIME type`, "warn"), !1))), this.toolsFiles[e.name] = {
      extensions: o || [],
      mimeTypes: i || []
    });
  }
  ...
  processHTML(e) {
    ...
    return o.innerHTML = e, this.getNodes(o).map((n) => {
      ...
      const { tags: c } = a.pasteConfig || { tags: [] }, u = c.reduce((m, p) => (this.collectTagNames(p).forEach((O) => {
        const _ = z(p) ? p[O] : null;
        m[O.toLowerCase()] = _ || {};
      }), m), {}), h = Object.assign({}, u, a.baseSanitizeConfig);
      if (s.tagName.toLowerCase() === "table") {
        const m = Z(s.outerHTML, h);
        s = d.make("div", void 0, {
          innerHTML: m
        }).firstChild;
      } else
        s.innerHTML = Z(s.innerHTML, h);
  ...
  async processInlinePaste(e) {
    ...
    if (t.currentBlock && t.currentBlock.tool.isDefault && i.textContent.length < Bt.PATTERN_PROCESSING_MAX_LENGTH) {
...
Et.PATTERN_PROCESSING_MAX_LENGTH = 450;
let ai = Et;
class li extends C {
  constructor() {
...
class fe extends C {
  ...
  changingRectangle(e) {
    ...
    this.rectCrossesBlocks = !(n || s), this.isRectSelectionActivated || (this.rectCrossesBlocks = !1, this.isRectSelectionActivated = !0, this.shrinkRectangleToPoint(), this.overlayRectangle.style.display = "block"), this.updateRectangleSize(), this.Editor.Toolbar.close(), i !== void 0 && (this.trySelectNextBlock(i), this.inverseSelection(), k.get().removeAllRanges());
  }
  /**
...
class ci extends C {
  ...
  async render(e) {
    return new Promise((t) => {
      const { Tools: o, BlockManager: i } = this.Editor, n = e.map(({ type: s, data: a, tunes: l, id: c }) => {
        o.available.has(s) === !1 && (K(`Tool «${s}» is not found. Check 'tools' property at the Editor.js config.`, "warn"), a = this.composeStubDataForTool(s, a, c), s = o.stubTool);
        let u;
        try {
          u = i.composeBlock({
            id: c,
...
class di extends C {
  ...
  async save() {
    ...
    try {
      ...
      const n = await Promise.all(i), s = await ct(n, (a) => t.blockTools.get(a).sanitizeConfig);
    ...
    return function(t) {
      ...
      function u(y, x) {
        for (var w = {}, I = [], R = 0; R < y.length; R++) {
          ...
          w[g] = E + 1;
          var A = c(T), S = { css: b[1], media: b[2], sourceMap: b[3] };
          A !== -1 ? (l[A].references++, l[A].updater(S)) : l.push({ identifier: T, updater: N(S, x), references: 1 }), I.push(T);
        }
        return I;
      }
      function h(y) {
...
/*# sourceMappingURL=data:application/json;base64,`.concat(btoa(unescape(encodeURIComponent(JSON.stringify(b)))), " */")), y.styleSheet)
      ...
      t.exports = function(y, x) {
        (x = x || {}).singleton || typeof x.singleton == "boolean" || (x.singleton = s());
        var w = u(y = y || [], x);
        return function(I) {
          ...
          return this.map(function(a) {
            var l = function(c, u) {
              ...
              if (u && typeof btoa == "function") {
                var m = (v = f, O = btoa(unescape(encodeURIComponent(JSON.stringify(v)))), _ = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(O), "/*# ".concat(_, " */")), p = f.sources.map(function(N) {
...
class je {
   ...
   */
  render() {
    return this.nodes.button = document.createElement("button"), this.nodes.button.type = "button", this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier), this.nodes.button.innerHTML = Xe, this.nodes.button;
  }
  /**
   * Input for the link
   */
  ...
  checkState() {
    ...
    if (e) {
      this.nodes.button.innerHTML = Fo, this.nodes.button.classList.add(this.CSS.buttonUnlink), this.nodes.button.classList.add(this.CSS.buttonActive), this.openActions();
      const t = e.getAttribute("href");
      this.nodes.input.value = t !== "null" ? t : "", this.selection.save();
    } else
      this.nodes.button.innerHTML = Xe, this.nodes.button.classList.remove(this.CSS.buttonUnlink), this.nodes.button.classList.remove(this.CSS.buttonActive);
    return !!e;
  }
  /**
...
class Ct {
   ...
   */
  make() {
    const e = d.make("div", this.CSS.wrapper), t = Ho, o = d.make("div", this.CSS.info), i = d.make("div", this.CSS.title, {
...
class pi extends Pe {
   ...
   */
  get title() {
    return this.constructable[De.Title];
  }
  /**
...
var gi = Object.defineProperty, bi = Object.getOwnPropertyDescriptor, St = (r, e, t, o) => {
...
Lt.isTune = !0;
var ki = Object.defineProperty, vi = Object.getOwnPropertyDescriptor, xi = (r, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? vi(e, t) : e, n = r.length - 1, s; n >= 0; n--)
    (s = r[n]) && (i = (o ? s(e, t, i) : s(i)) || i);
...
class yi extends C {
  ...
  watchBlockHoveredEvents() {
    ...
    this.readOnlyMutableListeners.on(this.nodes.redactor, "mousemove", Ce((t) => {
      ...
      this.Editor.BlockSelection.anyBlockSelected || o && e !== o && (e = o, this.eventsDispatcher.emit(xt, {
  ...
  documentClicked(e) {
    ...
    const i = this.Editor.BlockSettings.nodes.wrapper.contains(t), n = this.Editor.Toolbar.nodes.settingsToggler.contains(t), s = i || n;
  ...
  redactorClicked(e) {
    ...
    if (d.isAnchor(i) && n) {
      o();
      const u = i.getAttribute("href"), h = Wt(u);
      Kt(h);
      return;
    }
    const s = this.Editor.BlockManager.getBlockByIndex(-1), a = d.offset(s.holder).bottom, l = e.pageY;
...
class Bi {
  ...
  constructor(e) {
    ...
    this.isReady = new Promise((i, n) => {
      ...
      s.checkEmptiness(), a.enable(), this.configuration.autofocus && (n.setToBlock(i.blocks[0], n.positions.START), i.highlightCurrentNode()), t();
    }).catch((i) => {
  ...
  set configuration(e) {
    ...
    z(e) ? this.config = {
      ...
      holder: e
    }, Ie(!!this.config.holderId, "config.holderId", "config.holder"), this.config.holderId && !this.config.holder && (this.config.holder = this.config.holderId, this.config.holderId = null), this.config.holder == null && (this.config.holder = "editorjs"), this.config.logLevel || (this.config.logLevel = Ge.VERBOSE), Pt(this.config.logLevel), Ie(!!this.config.initialBlock, "config.initialBlock", "config.defaultBlock"), this.config.defaultBlock = this.config.defaultBlock || this.config.initialBlock || "paragraph", this.config.minHeight = this.config.minHeight !== void 0 ? this.config.minHeight : 300;
    const t = {
    ...
    }), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : !0, (V(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = { blocks: [t] }), this.config.readOnly = this.config.readOnly || !1, (o = this.config.i18n) != null && o.messages && Y.setDictionary(this.config.i18n.messages), this.config.i18n.direction = ((i = this.config.i18n) == null ? void 0 : i.direction) || "ltr";
  }
  /**
